...
<body>
    ...
    <h2>3. 문의하기</h2>
    <p>서비스 이용과 관련된 문의사항은 관리자 이메일로 문의해 주시기 바랍니다.</p>
...
# 2. 한국어 메인(index.html)에 SEO 텍스트 & 링크 추가
# 수정됨: @example.com 앞에 역슬래시(\) 추가
perl -0777 -pi -e 's|</body>|<section style="max-width: 800px; margin: 60px auto; text-align: left; padding: 20px; background-color:#f9f9f9; border-radius:10px;">
...
# 4. 한국어 메인(index.html)에 언어 감지 스크립트 추가
...
git add .
git commit -m "feat: add privacy policy, seo text, and english landing page"
